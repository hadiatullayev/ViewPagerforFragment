...
import developer.abdulahad.viewpagerforfragment.databinding.FragmentItem2Binding
...
class ItemFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        Glide.with(binding.root.context).load(param1).into(binding.imageItem)
        binding.tvItem.text =  param2

        binding.edt2.addTextChangedListener {
            binding.tvItem.text = it.toString()
        }
